...
* [Understanding the difference between mobile-first, adaptive and responsive design](https://fredericgonzalo.com/mobile-first-adaptatif-responsive-sy-retrouver/)
...
```
## Images
Use the images that you downloaded in the [CSS Advanced](https://intranet.hbtn.io/projects/1193) project and place them into an `images` directory at the root of the project.
